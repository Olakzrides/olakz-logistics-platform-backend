...
const server = app_1.default.listen(PORT, () => {
    ...
    logger_1.default.info(`OTP: ${config_1.default.otp.length} digits, expires in ${config_1.default.otp.expiryMinutes} minutes`);
    logger_1.default.info(`===========================================`);
    logger_1.default.info(`Email: ${config_1.default.email.from.email}`);
    logger_1.default.info(`Google OAuth: ${config_1.default.google.clientId ? 'Enabled' : 'Disabled'}`);
    logger_1.default.info(`===========================================`);
